...
class MovieScreenState extends ConsumerState<MovieScreen> {
  ...
  void initState() {    
    ...
    //read = onntap o onpresed paea redibujar
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: CustomScrollView(
        //physics: const ClampingScrollPhysics(), //rebote como IOS
        slivers: [
...
class _ActorsByMovie extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    } //Evaluacion para saber si tienen valores
...
class _CustomSliverAppBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final size = MediaQuery.of(context).size; //Medidas del dispositivo
      ...
      flexibleSpace: FlexibleSpaceBar(
        ...
        background: Stack(
          children: [
            ...
            //Gradiente para el front de retroceder
            const _CustomGradient(
